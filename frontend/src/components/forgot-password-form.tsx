...
import { forgotPasswordSchema, ForgotPasswordFormData } from "@/types/validation.types";
...
export const ForgotPasswordForm = memo<ForgotPasswordFormProps>(({ className }) => {
  const [isSuccess, setIsSuccess] = useState(false);
  const isSubmittingRef = useRef(false);

  const { register, handleSubmit, formState, watch } = useForm<ForgotPasswordFormData>({
